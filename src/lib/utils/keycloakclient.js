...
class KeycloakClient {
    ...
    async addUserToGroup(userId, groupName) {
        try {
            ...
            logger.error(`Error adding user ${userId} to group '${groupName}':`, error);
            throw error;
        }
    }
    ...
    async removeUserFromGroup(userId, groupName) {
        try {
            ...
            logger.error(`Error removing user ${userId} from group '${groupName}':`, error);
            throw error;
        }
    }
    ...
    async addUser(params) {
        ...
        try {
            ...
            logger.error('Error adding user to Keycloak:', error);
            throw {
    ...
    async findUserIdByUsername(username) {
        ...
        try {
            ...
            logger.error(`Error finding user ID for username '${username}':`, error);
            throw {
                message: `Failed to find user ID for username '${username}'`,
                originalError: error,
            };
        }
    }
